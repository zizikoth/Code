...
object AnimHelper {
	...
	fun createAlphaAnim(
		...
		to: Float,
		duration: Long,
		doMore: (animation: AlphaAnimation) -> Unit = {}
	): AlphaAnimation {
	 ...
	 */
	@JvmStatic
	fun createRotateAnim(
		duration: Long,
		repeatCount: Int = -1,
		doMore: (animation: RotateAnimation) -> Unit = {}
	): RotateAnimation {
	...
	fun createScaleAnim(
		...
		to: Float,
		duration: Long,
		doMore: (animation: ScaleAnimation) -> Unit = {}
	): ScaleAnimation {
	 ...
	 */
	@JvmStatic
	fun createVTranslateAnim(
		fromY: Float,
		toY: Float,
		duration: Long,
		doMore: (animation: TranslateAnimation) -> Unit = {}
	): Animation {
	...
	fun createRotate3dAnimGo(
		...
		openAnimation.setAnimationListener(object : Animation.AnimationListener {
			...
			override fun onAnimationEnd(animation: Animation) {
				...
				val rotateAnimation =
					Rotate3dAnimation(270f, 360f, mCenterX, mCenterY, depthZ, false)
