package com.memo.core.tool.behavior;
...
/**
 * title:
 * describe: 在底部可滑动组件没有滑动到顶部的时候，整体不进行下滑，在底部组件滑动到顶部的时候，整体开始下滑
 *
 * @author memo
 * @date 2019-11-05 15:43
...
public class AppBarLayoutBehavior extends AppBarLayout.Behavior {
	...
	public AppBarLayoutBehavior(Context context, AttributeSet attrs) {
		super(context, attrs);
		// 设置AppBarLayout永远可拖拽
		this.setDragCallback(new BaseDragCallback() {
			@Override
