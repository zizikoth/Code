...
import com.memo.core.tool.simple.SimpleGlideTarget
import java.io.File
...
object ImageLoadHelper {
	...
	fun loadResizeCircleImageListener(
		context: Context, url: Any, width: Int, height: Int,
	...
	fun getImageFileFromCache(
		context: Context, lifecycleOwner: LifecycleOwner, url: String,
